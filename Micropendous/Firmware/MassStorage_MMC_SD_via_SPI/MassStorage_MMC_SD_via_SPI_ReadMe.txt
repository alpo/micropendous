- works with any MMC or SD card which has SPI mode (most microSD cards support SPI)

- this demo is very slow slow compared to proper 
...
- requires one manual setting before compilation and programming
    ...
    - open MassStorage_MMC_SD_via_SPI.h and change #define DATAFLASH_PAGES to the above number of pages

- that is it, your Micropendous programmed with MassStorage_MMC_SD_via_SPI firmware will now behave like a
