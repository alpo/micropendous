...
#define BIT4		PB3		// TRST = JTAG RESET
#define BIT5		PB4		// SRST = RESET

#define BIT4_1	PD0		// TRST = JTAG RESET
#define BIT5_1	PD1		// SRST = RESET
...
#define BIT4_DDR    DDRB
#define BIT5_DDR    DDRB
#define BIT4_1_DDR    DDRD
#define BIT5_1_DDR    DDRD
...
#define BIT4_READ   PINB
#define BIT5_READ   PINB
#define BIT4_1_READ   PIND
#define BIT5_1_READ   PIND
#define BIT6_READ   PIND
...
#define BIT4_WRITE   PORTB
#define BIT5_WRITE   PORTB
#define BIT4_1_WRITE   PORTD
#define BIT5_1_WRITE   PORTD
#define BIT6_WRITE   PORTD
