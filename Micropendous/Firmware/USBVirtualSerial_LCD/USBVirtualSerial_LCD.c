...
/*
  ...
  Altered for USBVirtualSerial_LCD by Opendous Inc. 2009-09
  For more information visit:  www.Micropendous.org/USBVirtualSerial_LCD
...
#include "USBVirtualSerial_LCD.h"
