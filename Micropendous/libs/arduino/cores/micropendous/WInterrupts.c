...
/* USB AVR Interrupt Notes: AT90USBxx2 and AT90USBxxx6/7 have INT0..7
	interrupts while the ATmega32u4 has only INT0..3,6
*/
...
void attachInterrupt(uint8_t interruptNum, void (*userFunc)(void), int mode) {
	...
	if(interruptNum < EXTERNAL_NUM_INTERRUPTS) {
		...
		// the mode into place.
		// Modes: LOW = 0, CHANGE = 1, FALLING = 2, RISING = 3
