#    Purpose: Test the throughput of a Micropendous board loaded with Serial Port firmware
#        firmware with PD2,PD3 shorted.  Visit www.Micropendous.org/USBtoSerial for more info.
