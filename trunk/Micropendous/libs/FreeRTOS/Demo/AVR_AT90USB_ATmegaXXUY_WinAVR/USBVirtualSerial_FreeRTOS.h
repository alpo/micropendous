...
#ifndef _USB_VIRTUAL_SERIAL_FREERTOS_H_
#define _USB_VIRTUAL_SERIAL_FREERTOS_H_
	...
	/* Includes: */
		...
		/* Time delay between runs of USB and CDC tasks */
	...
	/* Global Variables related to USB Virtual Serial */
	...
	/* Function Prototypes: */
		...
		extern  int sendData(char c, FILE *stream);
		int getData(FILE *__stream);

		extern  void USBTask(void *pvParameters);
		extern  void CDCTask(void *pvParameters);
